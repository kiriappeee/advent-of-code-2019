...
def get_intersection_points_for_wires(instruction_list_A, instruction_list_B):
    points_travelled_for_A = set(get_points_for_given_instruction_set(instruction_list=instruction_list_A))
    points_travelled_for_B = set(get_points_for_given_instruction_set(instruction_list=instruction_list_B))
    ...
    return list(points_travelled_for_A & points_travelled_for_B)
