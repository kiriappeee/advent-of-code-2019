...
def getNextOperationMembers(array_to_extract_next_operation_from, starting_index=0):
    print('Starting instruction is: ' + str(array_to_extract_next_operation_from[starting_index])+ ' at ' + str(starting_index))
...
def run_program(full_array):
    ...
    while True:
        ...
        # print(next_operation_members['opcode'])
...
def run_part_one():
    ...
    resulting_array, outputs = run_program(puzzle_input)
    return outputs[-1]
